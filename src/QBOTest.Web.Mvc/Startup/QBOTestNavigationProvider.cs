...
namespace QBOTest.Web.Startup
{
    ...
    /// </summary>
    public class QBOTestNavigationProvider : NavigationProvider
    {
        ...
        {
            return new LocalizableString(name, QBOTestConsts.LocalizationSourceName);
        }
    }
}