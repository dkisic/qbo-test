...
using QBOTest.Models.TokenAuth;
...
{
    public abstract class QBOTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QBOTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QBOTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QBOTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QBOTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QBOTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QBOTestDbContext, Task<T>> func)
        {
            T result;
